...
class plant_ncs_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Plant Ncs 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Plant Ncs 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "plant_ncs_2")
        ...
        self.ieee802_15_4_mac_plant_0 = ieee802_15_4.mac_plant(False,1,0x8841,0,0x1aaa,0x02)
        self.blocks_socket_pdu_0_0_1 = blocks.socket_pdu("UDP_SERVER", '127.0.0.1', '5101', 10000, False)
        self.blocks_socket_pdu_0_0_0_0 = blocks.socket_pdu("UDP_CLIENT", '127.0.0.1', '5151', 10000, False)
...
def main(top_block_cls=plant_ncs_2, options=None):
